...
class AdapterFilmesFavoritos(private val listaFilmes: List<Filmes>, private val context: Context ) : RecyclerView.Adapter<AdapterFilmesFavoritos.MyViewHolder>() {

    private var storageReference: StorageReference? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val itemLista = LayoutInflater.from(parent.context).inflate(R.layout.adapter_listar_favoritos, parent, false)
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            foto = itemView.findViewById(R.id.img_filmeFavorito)
            nome = itemView.findViewById(R.id.txt_filmeFavorito)
