...
class AdapterPesquisaFilmes(private val listaFilmes: List<Filmes>, private val context: Context) : RecyclerView.Adapter<AdapterPesquisaFilmes.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.foto.setImageResource(R.drawable.filme_ic)
